...
pattern_ns = "^[А-ЯA-Z]"
pattern_email = r"([a-z_0-9]+@[a-z]+\.(ru|org|com))"

name = input("Ваше Имя: ")
if re.search(pattern_ns, name):
    print("Имя указано верно!")
else:
    print("Неверные данные , имя должно начинаться с большой буквы!")

sname = input("Ваша Фамилия: ")

if re.search(pattern_ns, sname):
    print("Вы ввели фамилию правильно!")
else:
    print("Неверные данные , фамилия должна начинаться с большой буквы!")

email = input("Введите ваш email: ")
if re.match(pattern_email, email):
    print("Вы ввели email правильно!")
else:
    print((email)," Укакан не верно! допускается нижнее подчеркивание и цифры, потом @, потом текст, допускаются цифры, точка, ru или org или com. ")
...
if re.search(pattern, some_str):
    print("Есть более 1 точки подряд")
else :
    print("Нет более 1 точки подряд")
